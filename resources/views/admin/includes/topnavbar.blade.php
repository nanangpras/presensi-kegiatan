<nav class="navbar navbar-expand-lg navbar-light navbar-store fixed-top navbar-fixed-top" data-aos="fade-down"
    ...
    <div class="container-fluid">
        ...
        <a href="#" class="navbar-brand mt-3">
            ...
            <h4 style="font-weight: 700;color: #057CE4;">Presensi</h4>
        </a>
        <a href="" class="navbar-toggler" data-toggle="collapse" data-target="#navbarResponsive" style="border: none">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <ul class="navbar-nav d-none d-lg-flex ml-auto">
                ...
                <li>
                    <a href="#">
                        <button class="btn btn-red mr-3">
                            Tutorials Youtube</button>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <button class="btn btn-blue-outline mr-3">
                            Telegram</button>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <button class="btn btn-green-outline mr-3">
                            Whatsapp</button>
                    </a>
                </li>
                <li class="nav-item dropdown mr-1">
                    <a href="" class="nav-link d-inline-block " type="button" class="btn btn-secondary dropdown-toggle"
                        data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle mr-2 profile-picture"
                            src="{{url('presensi/images/icon/notive2.png')}}" alt="" />
                    ...
                    <ul class="dropdown-menu" style="width: 450px; margin-left: -250px; margin-top: 15px;">
                        ...
                        <li class="notification-item p-3">
                            <a href="" class="d-flex notive">
                                <div class="mr-3 mb-auto text-center">
                                    <img src="images/square_pink.svg" alt="" style="max-width: 160px;max-height: 65px;">
                                </div>
                                <div class="notification-content mb-auto">
                                    <p style="
                                            font-size: 13px;
                ...
                <li class="nav-item">
                    ...
                    <div type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                        ...
                        <img class="rounded-circle mr-2 profile-picture" src="{{url('presensi/images/icon/exit.png')}}"
                            alt="" />
                    </div>
