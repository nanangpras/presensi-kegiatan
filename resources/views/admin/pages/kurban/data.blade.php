                            ...
                            <tbody class="body-table">
                                @foreach ($datakegiatan as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->jenis}}</td>
                                        <td>
                                            {{-- <a href="{{route('panitia-kurban.presensi',$item->event_id)}}" class="btn btn-sm btn-danger" role="button"><i class="nav-icon fa fa-trash-alt"></i>
                                                Presensi
                                            </a>
                                            <a href="{{route('panitia-kurban.detail',$item->event_id)}}" style="background-color: #F4E06D; color:white" class="btn btn-sm btn-danger" role="button"><i class="nav-icon fa fa-trash-alt"></i>
                                                Data Panitia
                                            </a> --}}
                                            <a href="{{route('panitia-kurban.detail',['key'=>'presensi_panitia'])}}&event={{$item->event_id}}" class="btn btn-sm btn-danger" role="button"><i class="nav-icon fa fa-trash-alt"></i>
                                                Presensi
                                            </a>
                                            <a href="{{route('panitia-kurban.detail',['key'=>'detail_panitia'])}}&event={{$item->event_id}}" style="background-color: #F4E06D; color:white" class="btn btn-sm btn-danger" role="button"><i class="nav-icon fa fa-trash-alt"></i>
                                                Data Panitia
                                            </a>
                                            <a href="{{route('panitia-kurban.create',$item->event_id)}}" style="background-color: #4CAF50; color:white" class="btn btn-sm btn-danger" role="button"><i class="nav-icon fa fa-trash-alt"></i>
                                                Tambah Panitia
                                            </a>
                                        </td>
                                    </tr>
