                        ...
                        <div class="dashboard-content">
                            <div class="row">
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="mb-5"
                                        style="border-radius: 15px; background-color: rgb(249, 230, 230); padding: 20px;filter: drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.09));">
                                ...
                                <div class="col-lg-7 col-6">
                                    <div class="mb-5"
                                        style="border-radius: 15px; background-color: white; padding: 20px;filter: drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.09));">
                                        <input type="text" placeholder="cari warga dengan NIK" class="form-control"
                                            id="nik">
                                        <br>
                                        <input type="text" placeholder="cari warga dengan nama" class="form-control"
                                            id="nama">
                                    </div>
                ...
                <div class="container-fluid table">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="" type="button" style="background-color: #d9b495; color:white" class="btn btn-danger" style="float: left;">cetak</a>
                            <br>
                        </div>
                        <div class="card-body">
                            <div>
