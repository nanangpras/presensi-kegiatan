    ...
    <div class="section-content section-dashboard-home aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
        <div class="container-fluid">
            <div class="row">
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="mb-5"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <h4 style="font-weight: 700; font-size: 30px; "> Media</h4>
                                                <p style="font-size: 14px;"> 40 Brosur </p>
                                ...
                                <div class="col-lg-4 col-12">
                                    <div class="mb-5"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8">
                                                <h4 style="font-weight: 700; font-size: 30px; "> Usaha</h4>
                                                <p style="font-size: 14px;"> <b>4</b> Maisah </p>
                ...
                <div class="col-lg-3 col-12 sidebar-information aos-init" data-aos="fade-up" data-aos-delay="200">
                    <div class="dashboard-heading">
                        <h5 class="dashboard-title">
                            Media
                        </h5>
